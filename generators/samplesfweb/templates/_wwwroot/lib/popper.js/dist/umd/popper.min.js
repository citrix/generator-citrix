 ...
 */ (function(
  ...
  typeof exports === 'object' && typeof module !== 'undefined'
    ? (module.exports = t())
    : typeof define === 'function' && define.amd ? define(t) : (e.Popper = t());
})(this, function() {
  'use strict';
  function e(e) {
  ...
  function y(e, t, i, r) {
    ...
    if (r === 'viewport') p = b(s);
      ...
      var a;
      r === 'scrollParent'
        ? ((a = n(o(t))), a.nodeName === 'BODY' && (a = e.ownerDocument.documentElement))
        : r === 'window' ? (a = e.ownerDocument.documentElement) : (a = r);
      var l = u(a, s);
  ...
  function S(e, t, o) {
    ...
    var i = L(e),
      ...
      a = r ? 'width' : 'height';
    return (
      (n[p] = t[p] + t[d] / 2 - i[d] / 2), (n[s] = o === s ? t[s] - i[a] : t[x(s)]), n
    );
  }
  function T(e, t) {
  ...
  function G(e, t) {
    var o,
      ...
      d = n.split('-')[0];
    return (
      (o = U(Number(i)) ? [Number(i), 0] : z(i, p, s, d)),
      d === 'left'
