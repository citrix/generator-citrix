...
var bootstrap = (function(t, e, n) {
  ...
  var s = (function() {
      ...
      function i() {
        ...
        for (var e in o) if (typeof t.style[e] !== 'undefined') return { end: o[e] };
        return !1;
      }
      function s(t) {
        var n = this,
          ...
          return (
            ...
            (o._jQueryInterface = function(t) {
              return this.each(function() {
                ...
                var r = typeof t === 'string' ? t : s.slide;
                if (
                  (i || ((i = new o(this, s)), e(this).data(n, i)), typeof t === 'number')
                )
                  i.to(t);
        ...
        d = (function() {
          function i(t, n) {
            ...
            for (var i = e(u.DATA_TOGGLE), r = 0; r < i.length; r++) {
              ...
              a !== null && e(a).filter(t).length > 0 && this._triggerArray.push(o);
            }
          ...
          return (
            ...
            (i._jQueryInterface = function(t) {
              return this.each(function() {
                var s = e(this),
                  r = s.data(n),
                  a = e.extend({}, o, s.data(), typeof t === 'object' && t);
                if (
          ...
          return (
            ...
            (a._jQueryInterface = function(t) {
              return this.each(function() {
                ...
                if (
                  (n || ((n = new a(this, s)), e(this).data(i, n)), typeof t === 'string')
                ) {
            ...
            (i._jQueryInterface = function(t, n) {
              return this.each(function() {
                var s = e(this).data('bs.modal'),
                  r = e.extend({}, i.Default, e(this).data(), typeof t === 'object' && t);
                if (
          ...
          return (
            ...
            (m._enter = function(t, n) {
              ...
              (n = n || e(t.currentTarget).data(i)) ||
                ...
                t && (n._activeTrigger[t.type === 'focusin' ? g.FOCUS : g.HOVER] = !0),
            ...
            (m._leave = function(t, n) {
              ...
              (n = n || e(t.currentTarget).data(i)) ||
                ((n = new this.constructor(t.currentTarget, this._getDelegateConfig())),
                e(t.currentTarget).data(i, n)),
                t && (n._activeTrigger[t.type === 'focusout' ? g.FOCUS : g.HOVER] = !1),
          ...
          return (
            (a.show = function() {
              ...
              if (
                ...
                if (l) {
                  var c = l.nodeName === 'UL' ? o.ACTIVE_UL : o.ACTIVE;
            ...
            (t._jQueryInterface = function(n) {
              return this.each(function() {
                var i = e(this),
                  s = i.data('bs.tab');
                if (
                  (s || ((s = new t(this)), i.data('bs.tab', s)), typeof n === 'string')
                ) {
