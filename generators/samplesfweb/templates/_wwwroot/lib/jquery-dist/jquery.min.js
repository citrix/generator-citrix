...
!(function(a, b) {
          ...
          c =
            c === 'true'
              ...
              : c === 'false'
                ...
                : c === 'null'
                  ? null
                  : String(Number(c)) === c ? Number(c) : N.test(c) ? n.parseJSON(c) : c;
        } catch (e) {}
        M.set(a, b, c);
      } else c = void 0;
    return c;
          ...
          function(a) {
            ...
            if (
              ...
              try {
                for (; d > c; c++)
                  (b = this[c] || {}),
                    b.nodeType === 1 && (n.cleanData(ob(b, !1)), (b.innerHTML = a));
                b = 0;
              } catch (e) {}
            }
      ...
      n.cssHooks[b] = {
        ...
        set: function(a, c, d) {
          ...
          return Gb(
            a,
            c,
            d ? Hb(a, b, d, n.css(a, 'boxSizing', !1, e) === 'border-box', e) : 0
          );
        }
      };
    }),
      ...
      '*': [
        function(a, b) {
          var c = this.createTween(a, b),
            ...
            g =
              (n.cssNumber[a] || (f !== 'px' && Number(d))) && Ob.exec(n.css(c.elem, a)),
            h = 1,
            i = 20;
          if (g && g[3] !== f) {
  ...
  a.attachEvent &&
    ...
    (k.cors = Boolean(Ec) && 'withCredentials' in Ec),
    (k.ajax = Ec = Boolean(Ec)),
