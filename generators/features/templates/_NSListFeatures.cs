...
namespace <%= appName %>
{
    ...
    {
       async static Task ListFeatures()
        {
            //create the URI for Netscaler login
            string nsURI = string.Format(@"http://{0}:{1}/nitro/v1/config/nsfeature",NSAddress,NSPort);
            ...
            Console.WriteLine("Return value from Netscaler CPX list features API");
