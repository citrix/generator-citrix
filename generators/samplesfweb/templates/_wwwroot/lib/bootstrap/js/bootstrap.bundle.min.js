...
var bootstrap = (function(t, e) {
  ...
  function a(t) {
    ...
    return n && n !== 'BODY' && n !== 'HTML'
      ? ['TD', 'TABLE'].indexOf(e.nodeName) !== -1 && r(e, 'position') === 'static'
        ? a(e)
        : e
  ...
  function l(t) {
    var e = t.nodeName;
    return e !== 'BODY' && (e === 'HTML' || a(t.firstElementChild) === t);
  }
  function c(t) {
    return t.parentNode !== null ? c(t.parentNode) : t;
  }
  function f(t, e) {
  ...
  function h(t) {
    var e =
        (arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 'top') === 'top'
          ? 'scrollTop'
          : 'scrollLeft',
      n = t.nodeName;
    if (n === 'BODY' || n === 'HTML') {
  ...
  function v(t, e) {
    var n = lt(),
      ...
      l = s(t),
      c = r(e),
      f = Number(c.borderTopWidth.split('px')[0]),
      h = Number(c.borderLeftWidth.split('px')[0]),
      d = m({
        top: o.top - a.top - f,
    ...
    if (((d.marginTop = 0), (d.marginLeft = 0), !n && i)) {
      var p = Number(c.marginTop.split('px')[0]),
        g = Number(c.marginLeft.split('px')[0]);
      (d.top -= f - p),
        (d.bottom -= f - p),
        (d.left -= h - g),
        (d.right -= h - g),
    ...
    return (n ? e.contains(l) : e === l && l.nodeName !== 'BODY') && (d = u(d, e)), d;
  }
  function E(t) {
  ...
  function T(t) {
    var e = t.nodeName;
    return e !== 'BODY' && e !== 'HTML' && (r(t, 'position') === 'fixed' || T(o(t)));
  }
  function b(t, e, n, i) {
    var r = { top: 0, left: 0 },
      a = f(t, e);
    if (i === 'viewport') r = E(a);
      ...
      var l = void 0;
      i === 'scrollParent'
        ? (l = s(o(t))).nodeName === 'BODY' && (l = window.document.documentElement)
        : (l = i === 'window' ? window.document.documentElement : i);
      var c = v(l, a);
      if (l.nodeName !== 'HTML' || T(a)) r = c;
      else {
        var h = g(),
          u = h.height,
          d = h.width;
  ...
  function D(t, e, n) {
    ...
    var i = O(t),
      ...
      c = o ? 'width' : 'height';
    return (
      (r[s] = e[s] + e[l] / 2 - i[l] / 2), (r[a] = n === a ? e[a] - i[c] : e[y(a)]), r
    );
  }
  function S(t, e) {
  ...
  function R(t) {
    for (
      ...
      var r = e[i],
        o = r ? String(r) + n : t;
      if (typeof window.document.body.style[o] !== 'undefined') return o;
    }
    return null;
  }
  function H() {
  ...
  function x() {
    this.state.eventsEnabled ||
      (this.state = W(this.reference, this.options, this.state, this.scheduleUpdate));
  }
  function M(t, e) {
    return (
  ...
  for (
    var X = (function() {
        ...
        function i() {
          ...
          for (var e in s) if (typeof t.style[e] !== 'undefined') return { end: s[e] };
          return !1;
        }
        function r(t) {
          var n = this,
            ...
            return (
              ...
              (r._jQueryInterface = function(t) {
                return this.each(function() {
                  ...
                  typeof t === 'object' && e.extend(s, t);
                  var a = typeof t === 'string' ? t : s.slide;
                  if (
          ...
          f = (function() {
            function i(t, n) {
              ...
              for (var i = e(c.DATA_TOGGLE), r = 0; r < i.length; r++) {
                ...
                s !== null && e(s).filter(t).length > 0 && this._triggerArray.push(o);
              }
            ...
            return (
                ...
                if (!this._isTransitioning && !e(this._element).hasClass(a.SHOW)) {
                  ...
                  if (
                    ...
                    if ((e(this._element).trigger(l), !l.isDefaultPrevented())) {
                      r &&
                        (i._jQueryInterface.call(e(r), 'hide'), o || e(r).data(n, null));
              ...
              (i._jQueryInterface = function(t) {
                return this.each(function() {
                  var o = e(this),
                    s = o.data(n),
                    a = e.extend({}, r, o.data(), typeof t === 'object' && t);
                  if (
  ...
  var st =
    ...
    at = void 0,
    lt = function() {
      return void 0 === at && (at = navigator.appVersion.indexOf('MSIE 10') !== -1), at;
    },
    ct = function(t, e) {
        ...
        offset: {
          ...
          fn: function(t, e) {
            var n = e.offset,
              ...
              l = void 0;
            return (
              (l = V(Number(n)) ? [Number(n), 0] : Y(n, o, s, a)),
              a === 'left'
                ...
                secondary: function(t) {
                  ...
                  return (
                    o[t] > i[t] &&
                      ...
                      (r = Math.min(o[n], i[t] - (t === 'right' ? o.width : o.height))),
                    ht({}, n, r)
                  );
                }
              };
            ...
            return (
              s.forEach(function(a, l) {
                ...
                var c = t.offsets.popper,
                  ...
                  h = Math.floor,
                  u =
                    (i === 'left' && h(c.right) > h(f.left)) ||
                    (i === 'right' && h(c.left) < h(f.right)) ||
                    (i === 'top' && h(c.bottom) > h(f.top)) ||
                    (i === 'bottom' && h(c.top) < h(f.bottom)),
                  d = h(c.left) < h(n.left),
        ...
        computeStyle: {
          ...
          fn: function(t, e) {
            ...
            var s = void 0 !== o ? o : e.gpuAcceleration,
              ...
              g = void 0;
            if (
              ((g = h === 'bottom' ? -l.height + f.bottom : f.top),
              (p = u === 'right' ? -l.width + f.right : f.left),
              s && d)
            )
  ...
  (_t.Utils = (typeof window !== 'undefined' ? window : global).PopperUtils),
    (_t.placements = dt),
    (_t.Defaults = mt);
  var vt = (function() {
        ...
        u = (function() {
          ...
          return (
            ...
            (u._getPopperConfig = function() {
              ...
              return (
                this._inNavbar && (i.modifiers.applyStyle = { enabled: !this._inNavbar }),
                i
              );
            }),
            (r._jQueryInterface = function(t) {
              return this.each(function() {
                ...
                if (
                  (i || ((i = new r(this, o)), e(this).data(n, i)), typeof t === 'string')
                ) {
            ...
            (i._jQueryInterface = function(t, n) {
              return this.each(function() {
                var r = e(this).data('bs.modal'),
                  o = e.extend({}, i.Default, e(this).data(), typeof t === 'object' && t);
                if (
          ...
          return (
            ...
            (d._setListeners = function() {
              ...
              this.config.trigger.split(' ').forEach(function(n) {
                if (n === 'click')
                  e(t.element).on(t.constructor.Event.CLICK, t.config.selector, function(
                    e
                  ) {
                    return t.toggle(e);
                  });
            ...
            (d._enter = function(t, n) {
              ...
              (n = n || e(t.currentTarget).data(i)) ||
                ...
                t && (n._activeTrigger[t.type === 'focusin' ? u.FOCUS : u.HOVER] = !0),
            ...
            (d._leave = function(t, n) {
              ...
              (n = n || e(t.currentTarget).data(i)) ||
                ((n = new this.constructor(t.currentTarget, this._getDelegateConfig())),
                e(t.currentTarget).data(i, n)),
                t && (n._activeTrigger[t.type === 'focusout' ? u.FOCUS : u.HOVER] = !1),
            ...
            (d._getConfig = function(n) {
              return (
                typeof (n = e.extend(
                  ...
                  e(this.element).data(),
                  n
                )).delay === 'number' && (n.delay = { show: n.delay, hide: n.delay }),
      ...
      var t = 'scrollspy',
        ...
        c = (function() {
          ...
          return (
            ...
            (c._getConfig = function(n) {
              if (typeof (n = e.extend({}, i, n)).target !== 'string') {
          ...
          return (
            (o.show = function() {
              ...
              if (
                ...
                if (a) {
                  var c = a.nodeName === 'UL' ? r.ACTIVE_UL : r.ACTIVE;
            ...
            (t._jQueryInterface = function(n) {
              return this.each(function() {
                var i = e(this),
                  r = i.data('bs.tab');
                if (
                  (r || ((r = new t(this)), i.data('bs.tab', r)), typeof n === 'string')
                ) {
  ...
  return (
    (function() {
      ...
      if ((t[0] < 2 && t[1] < 9) || (t[0] === 1 && t[1] === 9 && t[2] < 1) || t[0] >= 4)
        throw new Error(
