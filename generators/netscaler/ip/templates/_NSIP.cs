...
namespace <%= appName %>
{
    ...
    {
        async static Task Listips()
        {
            //create the URI for Netscaler login
            string nsURI = string.Format(@"http://{0}:{1}/nitro/v1/config/nsip",NSAddress,NSPort);
            ...
            Console.WriteLine("Return value from Netscaler CPX list IP API");
